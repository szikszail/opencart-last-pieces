...
class ControllerProductLastpieces extends Controller {
	public function index() { 
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/lastpieces.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/product/lastpieces.tpl';
		} else {
			$this->template = 'default/template/product/lastpieces.tpl';
		}
